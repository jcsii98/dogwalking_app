...
export default function BookingDetails(props) {
  ...
  return (
    <>
      <div
        className="mb-4 bg-white rounded-md p-6 border-slate-300 border-[1px] cursor-pointer"
        tabIndex="0"
      >
        <div
          onClick={() => {
        ...
        >
          <div className="font-bold text-xl flex w-full justify-between">
              ...
              <div className="flex items-center">
                {bookingDash.booking.status &&
                  bookingDash.booking.status == "approved" && (
                    <>
                      <img
                        className="ml-4 w-3 h-3 place-self-center"
                        src={Paw}
                      />
                    </>
                  )}
                  ...
                  {bookingDash.booking_dog_profiles &&
                    bookingDash.booking_dog_profiles.map((item) => {
                      ...
                      const markedForRemoval =
                        isBookingDogProfileMarkedForRemoval(item.id);
